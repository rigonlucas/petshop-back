...
class CreateRecurrenceAction extends BaseAction
{
    public function __construct(private ScheduleStoreAction $scheduleStoreAction)
    {
    }
    ...
    public function create(Schedule $schedule, array $recurrencies, User $user): Schedule
    {
        ...
        foreach ($recurrencies as $recurrence) {
            ...
            $this->scheduleStoreAction->store($scheduleData, $user);
        }
